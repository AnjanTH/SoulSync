                ...
                {!selectedExercise ? (
                    ...
                    >
                        {exercises.map((exercise) => (
                            <motion.div
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="bg-white rounded-xl p-6 shadow-lg cursor-pointer hover:shadow-xl transition-all border border-gray-100"
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center space-y-6">
                            ...
                            <motion.div 
                                className={`w-full max-w-md p-6 rounded-2xl cursor-pointer transition-all
                                    ${isListening 
                            ...
                            {transcript && (
                                <motion.div 
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    className="w-full bg-white rounded-xl p-6 shadow-md border border-gray-100"
                                >
                            ...
                            {response && (
                                <motion.div 
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    className="w-full bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 shadow-md border border-blue-100"
                                >
